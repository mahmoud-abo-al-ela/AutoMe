...
// Cache-key version for the L2 translation cache. Bump it whenever a cached
// translation would come back WRONG — that means prompt edits, but also changes to
// sanitizeFilters' semantics, because the cache stores post-sanitize filters.
// v2: null numeric fields no longer collapse to 0 (phantom minYear 1900 / minSeats 1).
export const SEARCH_FILTERS_PROMPT_VERSION = "v2";
...
- color: a single colour name ("red", "navy blue"), or null.
- minSeats: seat count for phrases like "7-seater" / "seats 7", or null.
