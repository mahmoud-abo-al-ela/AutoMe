...
export function serializeConversation(conversation) {
    ...
    return {
        ...
        participants: conversation.participants ? conversation.participants.map(serializeParticipant) : [],
        messages: conversation.messages ? conversation.messages.map(serializeMessage) : [],
