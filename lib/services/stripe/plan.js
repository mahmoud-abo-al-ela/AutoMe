...
export async function createPlanStripeResources(plan) {
    try {
        ...
        console.error("Error creating plan Stripe resources:", error);
        throw error;
    }
}
...
export async function updatePlanStripeResources(plan, existingPlan) {
    try {
        ...
        console.error("Error updating plan Stripe resources:", error);
        throw error;
    }
}
...
export async function archivePlanStripeResources(plan) {
    try {
        ...
        console.error("Error archiving plan Stripe resources:", error);
        throw error;
    }
}
