...
const getActionCategory = (action) => {
  ...
  if (action.includes("UPDATED") || action.includes("CHANGED") || action.includes("TOGGLED") || action.includes("UPGRADED") || action.includes("DOWNGRADED") || action.includes("RENEWED") || action.includes("CONFIRMED") || action.includes("COMPLETED") || action.includes("ACTIVATED") || action.includes("ACCEPTED")) return "UPDATE";
  if (action.includes("DELETED") || action.includes("REMOVED") || action.includes("CANCELED") || action.includes("SUSPENDED")) return "DELETE";
  ...
  return (
    <div className="space-y-4">
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        <Avatar className="h-8 w-8">
                          ...
                          />
                          <AvatarFallback>
                            {(log.user?.name || log.userEmail)?.charAt(0)?.toUpperCase() || "?"}
                          </AvatarFallback>
                        </Avatar>
                        <div>
      ...
      <Dialog
        ...
        onOpenChange={(open) => !open && setDetailsDialog({ open: false, log: null })}
      >
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-mono text-sm">{detailsDialog.log.entityId}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-muted-foreground">
                    Timestamp
